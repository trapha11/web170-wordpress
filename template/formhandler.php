...
$body ="Thank you for contacting me. Your input is valued.";
...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: tpham079@seattlecentral.edu' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'tpham079@seattlecentral.edu'; // if your client has more than one web site, you can put the site name here.
...
mail ('tpham079@seattlecentral.edu', $subject, $body, $from);
